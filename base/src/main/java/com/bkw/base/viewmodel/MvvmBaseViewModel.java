package com.bkw.base.viewmodel;
...
import com.bkw.base.model.IBaseModelListener;
import com.bkw.base.model.MvvmBaseModel;
import com.bkw.base.model.PagingResult;
...
public abstract class MvvmBaseViewModel<M extends MvvmBaseModel, D> extends ViewModel implements LifecycleObserver, IBaseModelListener<List<D>> {
    protected M model;
    public MutableLiveData<ObservableArrayList<Object>> dataList = new MutableLiveData();
