...
import com.bkw.base.preference.BasicDataPreferenceUtil;
    ...
    public void getCachedDataAndLoad() {
        if (mCachedPreferenceKey != null) {
            ...
            if (!TextUtils.isEmpty(saveDataString)) {
                try {
                    F savedData = JSON.parseObject(new JSONObject(saveDataString).getString("data"), clazz);
            ...
            if (mApkPredefinedData != null) {
                F savedData = JSON.parseObject(mApkPredefinedData, clazz);
                if (savedData != null && savedData != null) {
                    onSuccess(savedData, true);
                }
            }
